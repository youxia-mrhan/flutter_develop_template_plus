...
import 'package:common/res/style/theme_styles.dart';
import 'package:common/router/page_route_observer.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GlobalOperateProvider(
      child: MaterialApp(
        ...
        navigatorKey: navigatorKey, // 全局key
        onGenerateRoute: Routers.router.generator, // 使用路由找不到页面时，就会执行 onGenerateRoute
        theme: ThemeStyles.defaultTheme,
        home: PopScope( // PopScope：监听返回键，WillPopScope 3.16中过时，使用PopScope替换
            canPop: false,
